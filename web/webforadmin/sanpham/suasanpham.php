                ...
                <div class="body-headersanpham">
                    ...
                    <div class="tbl_them">
                        <form method="POST">
                            <table class="tlb-info">
                                <div class="user-info">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="file" class="info-name-property" id="Image" name="txtImage" value="<?php echo $Image ?>" required /></td>
                                    </tr>
                                    <tr>
                                        <td class="info-name"><label for="MieuTa">Miêu tả</label></td>
                                        <td><input type="text" class="info-name-property" id="MieuTa" name="txtMieuTa" value="<?php echo $MieuTa ?>" required /></td>
                                    </tr>
                                    <tr>
                                        <td class="info-name"><label for="MieuTa">Loại sản phẩm</label></td>
                                        <td><input type="text" class="info-name-property" id="Loai" name="txtLoai" value="<?php echo $Loai ?>" required /></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="info-name-property" id="Loai" name="txtLoai">
                                                ...
                                                ?>
                                                <option value="<?php echo $row_loai["idloaisanpham"] ?>" selected><?php echo $row_loai["tenloaisanpham"]?></option>
                                                <?php
                                                        }else{
                                                ?>
                            ...
                            <div class="tlb-add"><input type="submit" value="Hoàn tất sửa sản phẩm" class="btn-add" colspan="2" name="txtThem" /></div>
                        </form>
                        <?php
                        include("../../../config/config.php");
