    ...
    <div id="main">
        <div id="header">
            ...
            <div class="header__right">
                ...
                <span class="ti-user" id="openlogin"></span>
                <span class="ti-heart" id="openlove"></span>
                <span class="ti-shopping-cart" id="openshopping"></span>
            </div>
        </div>
        ...
        <div class="model" id="modal-signin">
            ...
            <div class="model-body">
                <div class="model-inner">
                    ...
                    <div class="auth">
                        <h2>Đăng ký</h2>
                        <p>Trở thành thành viên Routine để nhận nhiều những chương trình ưu đãi hấp dẫn</p>
                    </div>
                    <form method="post" action="../dangki.php">
                        ...
                        <div class="auth-control">
                            <div class="dk">
                                ...
                                <a href="">Tôi chấp nhận <u>điều khoản quyền riêng tư và bảo mật</u></a>
                            </div>
            ...
            <div class="modal-right">
                <div class="modal-love">
                    <div class="love-heading">
                        <p><i class="ti-heart"></i><b>Sản phẩm yêu thích</b></p>
                        <span class="ti-close"></span>
                    </div>
                </div>
            </div>
        ...
        <div class="model" id="modal-shopping">
            ...
            <div class="modal-right">
                <div class="modal-love">
                    <div class="love-heading">
                        <p><i class="ti-shopping-cart"></i><b>Giỏ hàng</b></p>
                        <span class="ti-close"></span>
                    </div>
                </div>
            </div>
